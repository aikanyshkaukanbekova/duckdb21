...
def add_plane(
    ...
    """
    Добавить автобусов в базу данных.
    """
    conn = duckdb.connect(str(database_path))
    cursor = conn.cursor()
    ...
    # Добавить информацию о новом автобусе.
    cursor.execute(
        """
...
def select_by_type(
    ...
    """
    Выбрать автобусы с заданным типом.
    """
...
def main(command_line=None):
    ...
    # Создать субпарсер для добавления автобуса.
    ...
    # Создать субпарсер для отображения всех автобусов.
    ...
    # Создать субпарсер для выбора автобусов.
